...
# 임시 데이터 : 할 일 저장
todos = [
    {"id":1, "title":"FastAPI 공부", "is_done":False},
    {"id":2, "title":"Python 공부", "is_done":True},
    {"id":3, "title":"HTTP 공부", "is_done":True},
    {"id":4, "title":"CSS 공부", "is_done":False}
]
...
#           기존 데이터를 요청 본문의 데이터로 통째로 덮어쓴다.
#           요청 본문의 특정 필드가 누락되면 해당 필드의 기존 값이 사라질 수 있다.
