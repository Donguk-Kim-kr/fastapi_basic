# ============================================
# SQLAlchemy_2.0_football/pytest_crud.py
#
# pytest로 단위 테스트
# ============================================
import pytest
...
def db_session():
    ...
    scope="function" --> 테스트 하나의 세션을 새로 만든다.
...
def test_get_players_by_name(db_session):
    ...
    first_name / last_name 두 조건을 동시에 걸어서 정확히 1명이 나오는지(동명이인X)
    그 결과로 나온 1명이 정확히 원하는 선수인지 player_id로 재확인
    """
